...
Based on this breakdown, we will create three child components for our Tabs component, each responsible for managing a specific aspect of the functionality. But first,
let's start with the Tabs component itself, which will be responsible for orchestrating the functionality of its child components.
