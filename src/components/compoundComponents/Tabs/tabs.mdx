<CH.Scrollycoding>
    ...
    On clicking this button, it triggers the `changeTab` function from the context changing the `activeTab` state. Any other component that’s accessing this state will be re-rendered.
