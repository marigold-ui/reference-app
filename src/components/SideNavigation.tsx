...
export const SideNavigation = () => {
  ...
  return (
    <aside
      id="default-sidebar"
      className="fixed left-0 top-0 z-40 h-screen w-[--page-side-nav-absolute-width] -translate-x-full border-y-0 border-l-0 border-r border-solid border-gray-200 transition-transform sm:translate-x-0"
      aria-label="Sidebar"
    >
